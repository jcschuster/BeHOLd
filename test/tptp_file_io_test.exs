defmodule BeHOLd.TPTP.FileIOTest do
  ...
  describe "parse_file/2 - file reading" do
    ...
    @tag :skip_unless_tptp_root
    test "parse_file with TPTP library (requires TPTP_ROOT)" do
      if System.get_env("TPTP_ROOT") do
        ...
        {:skip, "TPTP_ROOT environment variable not set"}
      end
    end
  end
